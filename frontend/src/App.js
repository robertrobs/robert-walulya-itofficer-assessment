  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif", minHeight: "100vh", background: "#f4f6f9" }}>
      ...
      <nav style={styles.nav}>
        <span style={styles.brand}>UIBFS Helpdesk Assessment</span>
...
const styles = {
  nav: { background: "#ffffff", padding: "12px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" },
  brand: { color: "#fff", fontSize: 20, fontWeight: "bold" },
  navLinks: { display: "flex", gap: 10 },
  navBtn: { padding: "8px 16px", border: "none", borderRadius: 6, cursor: "pointer", background: "transparent", color: "#080707", fontSize: 14 },
